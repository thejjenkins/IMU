...
def lpf_butter(x, cutoff_hz, order=3):
    b, a = butter(order, cutoff_hz/(fs/2), btype='low', fs=fs)
...
plot_timeseries(df_acc_body, "Accelerometer Body (x, y, z)")
plot_timeseries(df_acc_grav, "Accelerometer Grav (x, y, z)")
